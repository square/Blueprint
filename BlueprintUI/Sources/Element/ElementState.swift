...
final class ElementState {
    ...
    static var enableCrossLayoutCaching: Bool?
    private var isCrossLayoutCachingEnabled: Bool { Self.enableCrossLayoutCaching ?? false }
    ...
    func layout(
        ...
        if !isCrossLayoutCachingEnabled {
