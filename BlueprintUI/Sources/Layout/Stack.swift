...
extension StackLayout {
    ...
    private func _layout(size: CGSize, items: [LayoutItem<Traits>]) -> [LayoutAttributes] {
    ...
    private func _measureIn(constraint: SizeConstraint, items: [LayoutItem<Traits>]) -> CGSize {
