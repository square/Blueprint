...
final class HintingSizeCacheTests: XCTestCase {
    ...
    func test_searchUnconstrainedKeys() {
        ...
        assertMisses(
            ...
            options: .init(hintRangeBoundaries: false, searchUnconstrainedKeys: true, stringNormalizationCache: false)
        )
    ...
    func test_hintRangeBoundariesAndSearchUnconstrained() {
        ...
        assertMisses(
            ...
            options: .init(hintRangeBoundaries: true, searchUnconstrainedKeys: true, stringNormalizationCache: false)
        )
    }
