...
extension AttributedLabel {
    ...
    final class LabelView: UILabel {
        ...
        override var accessibilityCustomRotors: [UIAccessibilityCustomRotor]? {
            ...
            get { linkElements != nil ? [linkElements.accessibilityRotor(systemType: .link)] : [] }
        }
                    ...
                    linkElements = links
                        ...
                        .compactMap { link in
                            ...
                            let element = LinkElement(
                                label: attributedText.attributedSubstring(from: link.range).string,
                                link: link
                            )
                            return element
                        }
...
extension AttributedLabel {
    struct Link: Equatable, Hashable {
        ...
        var boundingRect: CGRect {
            ...
            // preferred over the former. The correct fix for this would be to return bezier paths that encompass exactly the linked portion.
            let rects = { () -> [CGRect] in
