...
class AccessibilityContainerTests: XCTestCase {
    ...
    func test_recursiveAccessibleSubviewsIncludesContainedElements() {
        ...
        let accessibleSubviews = outerContainerView.recursiveAccessibilityElements() as! [UIView]
    ...
    func test_nestedSubviewsAreFound() {
        ...
        let accessibleSubviews = containerView.recursiveAccessibilityElements() as! [UIView]
